...
function DotGroup({
  ...
  // Imperative material keeps the sprite map stable across notification-driven re-renders.
  ...
  return <points geometry={geo} material={mat} onClick={onClick} dispose={null} />;
}
