    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRight: '1px solid rgba(0,232,135,0.28)',
          backdropFilter: 'blur(20px)',
          boxShadow: '4px 0 40px rgba(0,232,135,0.12)',
        }}>

      {/* Corner brackets */}
      <span style={{
        position: 'absolute', top: -1, right: -1, width: 14, height: 14,
        borderTop: '2px solid rgba(0,232,135,0.9)', borderRight: '2px solid rgba(0,232,135,0.9)',
      ...
      <span style={{
        ...
        borderBottom: '2px solid rgba(0,232,135,0.9)', borderLeft: '2px solid rgba(0,232,135,0.9)',
        animation: 'corner-blink 4s ease-in-out infinite 2s', pointerEvents: 'none', zIndex: 2,
      }} />

      {/* Header */}
      <div className="flex items-center gap-2 px-3 py-2 flex-shrink-0"
        style={{ background: 'rgba(0,10,6,0.95)', borderBottom: '1px solid rgba(0,232,135,0.28)' }}>
      ...
      <div className="px-3 py-1 flex-shrink-0"
        style={{ borderTop: '1px solid rgba(0,232,135,0.18)', background: 'rgba(0,8,4,0.9)' }}>
        <span style={{ fontFamily: 'Share Tech Mono, monospace', fontSize: 12, color: '#00e887', letterSpacing: '0.15em' }}>
