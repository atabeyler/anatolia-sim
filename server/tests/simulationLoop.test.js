 ...
 * We do NOT run a full tick (requires DB + worker pool); instead we test
 * internal methods and state transitions directly.
 */
...
describe('SimulationEngine.estimateGenerations()', () => {
  ...
  it('ignores dead individuals', () => {
    ...
    engine._aliveIds.add(alive.id); // dead not added
    engine.currentDay = 0;
