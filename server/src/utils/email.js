...
<table style="width:100%;border-collapse:collapse;margin-bottom:24px;font-size:14px">
  <tr><td style="color:#6070a0;padding:6px 0;width:140px">Ad Soyad</td><td style="color:#e0e8ff;font-weight:bold">${first_name} ${last_name}</td></tr>
  <tr><td style="color:#6070a0;padding:6px 0">TC No</td><td style="color:#e0e8ff">${tc_no}</td></tr>
  <tr><td style="color:#6070a0;padding:6px 0">E-posta</td><td style="color:#e0e8ff">${email}</td></tr>
  <tr><td style="color:#6070a0;padding:6px 0">Kullanici Kodu</td><td style="color:#e0e8ff;font-weight:bold">${user_code_temp}</td></tr>
</table>
<a href="${reviewLink}" style="display:inline-block;padding:14px 32px;background:rgba(79,110,247,0.25);border:1px solid rgba(79,110,247,0.6);color:#a0b4ff;text-decoration:none;font-size:13px;letter-spacing:.15em">&#10003; / &#10007; &nbsp; iNCELE &amp; KARAR VER</a>
