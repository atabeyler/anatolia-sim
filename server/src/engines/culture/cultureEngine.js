...
const MEME_DESC={shared_greeting:'A consistent greeting gesture develops',mourning_ritual:'Communal mourning practices emerge for the dead',food_sharing_norm:'Food is shared equally among group members',reciprocity_norm:'Gifts and favors are expected to be returned',gender_roles:'Different tasks become associated with different sexes',age_hierarchy:'Elders are accorded special respect',gift_exchange:'Ceremonial gift-giving strengthens social bonds',body_decoration:'Pigments and natural materials used for body adornment',storytelling:'Oral narratives preserve group memory and values',music_drumming:'Rhythmic percussion emerges as social bonding activity',dance_ritual:'Coordinated movement used in group ceremonies',naming_ceremony:'Birth is marked with naming rites',marriage_ceremony:'Pair-bonding is formalized through ritual',seasonal_festival:'Cyclical celebrations mark the seasons',taboo_system:'Certain behaviors become culturally forbidden',trade_ceremony:'Exchange is ritualized to build trust',written_myth:'Origin stories are recorded in written form',legal_code:'Rules and punishments are written and formalized'};
